...
const LOCAL_PASSAGES = [
  "India's digital public infrastructure has changed how citizens access payments, identity services, and benefit delivery at an unprecedented scale. The policy conversation is no longer only about creating rails like digital identity or real-time payment interfaces, but about ensuring reliability, grievance resolution, inclusion, and transparent safeguards as usage deepens across urban and rural regions. For typists, this paragraph is intentionally long and varied: it mixes short connector words with long institutional terms, punctuation pauses, and layered sentence structure so that you practice rhythm control, error recovery, and sustained focus under a sixty-second timer.",
  "Metro expansion in major Indian cities has highlighted the importance of integrated mobility where buses, feeder routes, cycle corridors, and walking networks work together instead of operating in isolation. Transport economists point out that ridership outcomes depend as much on interchange quality, schedule coordination, and first-mile access as on headline track length, because commuters judge the full journey experience rather than one segment alone. This passage is built to improve endurance typing: there are hyphenated words, repeated policy vocabulary, and long clauses that reward smooth breathing, stable hand position, and deliberate correction without breaking speed momentum.",
  "India's renewable energy transition now depends not only on generation capacity but also on transmission planning, storage reliability, and distribution reform. As variable solar and wind penetration rises, operators need better forecasting, flexible dispatch tools, and regional balancing arrangements so that supply remains dependable during peak evening demand and weather-driven fluctuations. Policy analysts also emphasize domestic manufacturing depth, financing discipline, and grid modernization standards to keep the transition affordable over time. This is a longer practice block designed to push consistency across technical wording, commas, and sentence length while preserving accuracy at pace.",
  "Foundational literacy and numeracy initiatives across states are increasingly focusing on teacher mentoring, classroom diagnostics, multilingual support, and targeted remediation for learners who need additional help. Education practitioners note that durable improvement comes from frequent formative assessment, practical lesson design, and sustained community engagement rather than one-time interventions or tool-centric campaigns. In parallel, education technology is being repositioned as a support layer that complements pedagogy, not a replacement for it, with better alignment to curriculum outcomes and local language contexts. This extended passage strengthens long-form concentration and trains you to maintain precision through dense, information-rich prose.",
];
