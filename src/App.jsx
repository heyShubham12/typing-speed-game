...
const LOCAL_PASSAGES = [
  "India's digital public infrastructure has changed how citizens access payments, identity services, and benefit delivery at an unprecedented scale, and the next phase is focused on trust, reliability, and inclusion at the last mile. Policymakers are examining how grievance systems respond during outages, how consent flows are communicated in local languages, and how data minimization can be enforced while services remain fast for ordinary users. Financial inclusion experts also note that adoption quality matters as much as raw transaction volume, because users need clear reversal timelines, transparent fee information, and accessible customer support when a payment fails at a critical moment. For typing practice, this passage is intentionally dense and extended: it combines institutional vocabulary, short transition words, punctuation-heavy clauses, and long connected arguments so that you train rhythm control, error recovery, and concentration over a full one-minute sprint without relying on brief sentence bursts.",
  "Metro expansion in major Indian cities has highlighted the importance of integrated mobility where buses, feeder routes, cycle corridors, and safe walking infrastructure work together instead of operating in isolation. Transport planners increasingly evaluate commute quality from door to destination, not only by counting train frequency, because most riders experience delays at transfers, station access points, and first-mile gaps before they even enter the system. Urban economists add that fare integration, timetable coordination, and real-time public information can meaningfully reduce uncertainty for workers, students, and caregivers who depend on predictable arrival windows. Local governments are also experimenting with public realm upgrades around stations, including shaded pathways, safer crossings, and structured pickup zones, so that transit feels practical for daily users rather than occasional riders. This paragraph is long by design and helps you practice endurance typing through varied sentence lengths, hyphenated terms, repeated policy language, and punctuation patterns that reward calm correction and steady hand movement.",
  "India's renewable energy transition now depends not only on adding generation capacity but also on transmission planning, storage reliability, market design, and disciplined distribution reform across states. As variable solar and wind penetration rises, grid operators require better forecasting models, flexible dispatch arrangements, and resilient balancing mechanisms to maintain dependable supply during evening peaks and weather-driven fluctuations. Energy analysts point out that investment quality is increasingly tied to project execution timelines, evacuation infrastructure, and payment reliability in downstream utilities, since delays in one segment can reduce confidence across the entire value chain. At the same time, policymakers are encouraging domestic manufacturing depth in critical components, while setting stronger standards for safety, recycling, and lifecycle cost transparency so affordability remains credible over the long term. This longer passage is crafted for focused practice: technical nouns, numeric-style phrasing, and multi-clause structure help train precision when fatigue appears and teach you to preserve accuracy without collapsing typing speed.",
  "Foundational literacy and numeracy initiatives across Indian states are increasingly focused on classroom diagnostics, teacher mentoring, multilingual support, and targeted remediation for learners who need sustained attention over multiple terms. Practitioners emphasize that durable gains come from regular formative assessment, practical lesson design, and iterative feedback loops between schools, district teams, and families, rather than one-time campaigns that produce short-lived improvement. Education technology is now being repositioned as a support layer that complements pedagogy, with better alignment to curriculum milestones, local language contexts, and measurable classroom outcomes that teachers can act on immediately. Policy discussions also highlight the value of peer learning communities, low-burden assessment tools, and clear guidance for mixed-ability classrooms where progress rates differ significantly. This extended passage is intentionally information-rich and helps you build long-form typing consistency through repeated academic vocabulary, punctuation transitions, and layered reasoning that requires attention to every word boundary while still encouraging strong WPM performance.",
];
