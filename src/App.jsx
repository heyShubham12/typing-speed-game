...
const LOCAL_PASSAGES = [
  "India's digital public infrastructure has improved daily access to payments, identity-linked services, and direct benefit transfers. Current policy focus is on reliability, transparent grievance handling, and language accessibility so users in both large cities and small towns can resolve issues quickly. Experts say adoption quality matters as much as transaction volume, because people need clear timelines, safe consent flows, and dependable support when failures occur. This passage helps typing practice by mixing short and long words, policy terms, punctuation pauses, and connected ideas that require steady rhythm, controlled corrections, and sustained focus through the full sixty-second timer.",
  "Metro growth in Indian cities has shown that transport success depends on complete journeys, not rail lines alone. Buses, walking access, feeder links, and safer crossings must connect smoothly for commuters to trust public transit every day. Planners now track interchange quality, first-mile reliability, and schedule coordination because small delays at transfer points can reduce overall ridership confidence. Local upgrades around stations, such as shaded paths and organized pickup zones, improve usability for students, workers, and families. This passage is designed for typing endurance with varied sentence length, repeated mobility vocabulary, and punctuation patterns that train precision while maintaining consistent speed.",
  "India's clean energy transition now requires stronger transmission networks, better storage systems, and practical distribution reform alongside new generation capacity. As solar and wind output grows, grid operators need accurate forecasting, flexible dispatch, and dependable balancing tools to maintain stability during evening peaks and changing weather. Analysts also highlight execution discipline, payment reliability, and infrastructure timelines, because one weak link can slow confidence across the full sector. Policymakers are encouraging domestic manufacturing and higher safety standards so long-term affordability remains realistic. This passage supports typing flow through technical wording, comma-heavy structure, and multi-clause arguments that challenge speed, consistency, and correction control.",
  "Foundational literacy and numeracy efforts across Indian states are increasingly centered on classroom diagnostics, teacher mentoring, and targeted support for students who need additional practice time. Educators emphasize that durable progress comes from frequent assessment, practical lesson planning, and regular feedback loops between schools, district teams, and families. Technology is most useful when it supports pedagogy, aligns with curriculum goals, and works in local language contexts for real classroom use. Policy discussions also stress peer learning communities and low-burden tools for mixed-ability classes. This passage improves typing concentration with academic vocabulary, long sentence structure, and transitions that require accuracy under steady time pressure.",
];
    ...
    <>
      ...
      <main className="layout">
        <section className="panel controls">
          <h2>Round Setup</h2>
          <div className="row">
            <div className="status">60-second typing challenge.</div>
          </div>
